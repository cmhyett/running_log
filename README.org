...
#+PLOT: set:"term pngcairo size 500,300" title:"Mileage" ind:1 deps:(2) type:2d with:histograms set:"yrange [0:8]" set:"xrange[-0.5:6.5]" file:"./imgs/jan1.png"
...
| 1/7        |         |                |            |        |  0.00 |      0.00 |          |        |                |
|------------+---------+----------------+------------+--------+-------+-----------+----------+--------+----------------|
| Wk 1/1-1/7 |     13. |            997 | 2@ 13' 56" | #ERROR | 10.47 |      3.28 |          |    154 |         #ERROR |
|------------+---------+----------------+------------+--------+-------+-----------+----------+--------+----------------|
